python batch_evaluate_booster.py --eval_dataset /home/hyang/llava_paso/output_llm/LLaVA-v1.5-MoCa-7B.json --model_path PKU-Alignment/beaver-dam-7b --output_dir /home/hyang/llava_paso/output_judge --beta_val 1
